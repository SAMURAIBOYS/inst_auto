...
class ImageGenerator:
    ...
    def _paint_decorative_polygons(self, canvas: List[List[Color]]) -> None:
        # decorative shapes stay behind content and are limited to background framing zones
        no_decoration_zones = [
            (59, 58, 1020, 219),
            (89, 260, 499, 951),
            (560, 260, 990, 951),
        ...
        self._fill_polygon(canvas, [(720, 0), (1080, 0), (1080, 430), (804, 706), (432, 1080), (0, 1080), (0, 756)], (176, 155, 162), alpha=0.62)
        self._fill_polygon(canvas, [(860, 1038), (1080, 818), (1080, 1080), (432, 1080)], (243, 40, 56), alpha=0.78)
        self._fill_rect(canvas, 0, 0, 40, 1080, (28, 35, 44), alpha=0.22)
        self._fill_rect(canvas, 1040, 0, 1080, 1080, (48, 34, 40), alpha=0.18)
        self._fill_rect(canvas, 40, 40, 1040, 1040, (24, 30, 36), alpha=0.06)
